========================================================================
    ACTIVEX CONTROL DLL : SBXPC Project Overview
========================================================================

ControlWizard has created this project for your SBXPC ActiveX Control
...
that make up your SBXPC ActiveX Control DLL.
...
SBXPC.ico
    ...
    is included by the main resource file SBXPC.rc.

/////////////////////////////////////////////////////////////////////////////
CSBXPCCtrl control:

SBXPCCtrl.h
    This file contains the declaration of the CSBXPCCtrl C++ class.

SBXPCCtrl.cpp
    This file contains the implementation of the CSBXPCCtrl C++ class.

SBXPCPropPage.h
    This file contains the declaration of the CSBXPCPropPage C++ class.

SBXPCPropPage.cpp
    This file contains the implementation of the CSBXPCPropPage C++ class.

CSBXPCCtrl.bmp
    This file contains a bitmap that a container will use to represent the
    CSBXPCCtrl control when it appears on a tool palette.  This bitmap
    is included by the main resource file SBXPC.rc.
...
stdafx.h, stdafx.cpp
    ...
    named SBXPC.pch and a precompiled types (PCT) file named stdafx.obj.
