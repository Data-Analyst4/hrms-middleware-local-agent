...
Friend Class frmMain
    ...
    Private Sub cmdScreenSaver_Click(ByVal sender As System.Object, ByVal e As System.EventArgs)
        frmScreenSaver.Visible = True
        Me.Visible = False
    End Sub

    Private Sub cmdEventCapture_Click(ByVal sender As System.Object, ByVal e As System.EventArgs)
        frmEvent.Visible = True
        Me.Visible = False
    End Sub

    Private Sub CmdTrString_Click(sender As Object, e As EventArgs) Handles cmdTrString.Click
        frmTrString.Visible = True
        Me.Visible = False
    End Sub

    Private Sub BtnNetworkSetting_Click(sender As Object, e As EventArgs) Handles btnNetworkSetting.Click
        frmNetworkSetting.Visible = True
        Me.Visible = False
    End Sub

    Private Sub BtnLogServerSetting_Click(sender As Object, e As EventArgs) Handles btnLogServerSetting.Click
        frmLogServerSetting.Visible = True
        Me.Visible = False
    End Sub

    Private Sub BtnNtpServerSetting_Click(sender As Object, e As EventArgs) Handles btnNtpServerSetting.Click
        frmNtpServerSetting.Visible = True
        Me.Visible = False
    End Sub
End Class