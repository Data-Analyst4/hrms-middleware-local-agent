...
Module mdlPublic
    ...
    Public Const gCompressPhotoSize_8K As Integer = 8192            ' 8K
    Public Const gCompressPhotoSize_32K As Integer = 32 * 1024      ' 32K
    Public Const gTempPhotoFile As String = "D:\TempPhoto.jpg"
    ...
    Function pubLongToIPAddr(ByVal vValue As Integer) As String
        Dim txtIP As String
