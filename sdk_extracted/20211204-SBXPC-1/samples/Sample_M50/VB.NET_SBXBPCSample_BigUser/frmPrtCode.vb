...
Friend Class frmSerialNo
    ...
    Private Sub cmdGetDeviceModel_Click(sender As Object, e As EventArgs) Handles cmdGetDeviceModel.Click
        Dim vRet As Boolean
        Dim dwIsBigUserId As Integer
        Dim dwCompanyType As Integer
        Dim dwMachineType As Integer
        Dim dwMachineVersion As Integer
        Dim str As String

        vRet = sbxpc.SBXPCDLL.GetDeviceModel(mMachineNumber, dwIsBigUserId, dwCompanyType, dwMachineType, dwMachineVersion)

        str = "isBigUser = " & CStr(dwIsBigUserId) & ", MachineType = " & CStr(dwMachineType)
        lblMessage.Text = str
