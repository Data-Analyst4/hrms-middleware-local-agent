...
#Region "Not Tested Part 2"
        ...
        Private Shared Function _ReadGeneralLogData_Ext(dwMachineNumber As Int32, bReadMark As Byte) As Byte
        End Function

        Public Shared Function ReadGeneralLogData_Ext(dwMachineNumber As Int32, bReadMark As Byte) As Boolean
            Return _ReadGeneralLogData_Ext(dwMachineNumber, bReadMark) > 0
        End Function
        ...
        Public Shared Function GetGeneralLogData(dwMachineNumber As Int32, ByRef dwTMachineNumber As Int32, ByRef dwEnrollNumber As Int32, ByRef dwEMachineNumber As Int32, ByRef dwVerifyMode As Int32, ByRef dwYear As Int32,
            ...
            Try
                ...
                Dim ret As Byte = _GetGeneralLogData(dwMachineNumber, addr_dwTMachineNumber, addr_dwEnrollNumber, addr_dwEMachineNumber, addr_dwVerifyMode, addr_dwYear,
        ...
        <DllImport("SBXPCDLL.dll", CallingConvention:=CallingConvention.Winapi)>
        Private Shared Function _GetGeneralLogData_Ext(dwMachineNumber As Int32, dwTMachineNumber As IntPtr, dwEnrollNumber As IntPtr, dwEMachineNumber As IntPtr, dwVerifyMode As IntPtr, dwYear As IntPtr,
            dwMonth As IntPtr, dwDay As IntPtr, dwHour As IntPtr, dwMinute As IntPtr, dwSecond As IntPtr, dwGlogExt As IntPtr) As Byte
        End Function

        Public Shared Function GetGeneralLogData_Ext(dwMachineNumber As Int32, ByRef dwTMachineNumber As Int32, ByRef dwEnrollNumber As Int32, ByRef dwEMachineNumber As Int32, ByRef dwVerifyMode As Int32, ByRef dwYear As Int32,
            ByRef dwMonth As Int32, ByRef dwDay As Int32, ByRef dwHour As Int32, ByRef dwMinute As Int32, ByRef dwSecond As Int32, ByRef dwGlogExt As Int32) As Boolean
            dwTMachineNumber = 0
            dwEnrollNumber = 0
            dwEMachineNumber = 0
            dwVerifyMode = 0
            ...
            Dim bin_dwMinute As Byte() = New Byte(3) {}
            Dim bin_dwSecond As Byte() = New Byte(3) {}
            Dim bin_dwGlogExt As Byte() = New Byte(3) {}
            ...
            Dim gh_dwMinute As GCHandle = GCHandle.Alloc(bin_dwMinute, GCHandleType.Pinned)
            Dim gh_dwSecond As GCHandle = GCHandle.Alloc(bin_dwSecond, GCHandleType.Pinned)
            Dim gh_dwGlogExt As GCHandle = GCHandle.Alloc(bin_dwGlogExt, GCHandleType.Pinned)
            ...
            Try
                ...
                Dim addr_dwMinute As IntPtr = gh_dwMinute.AddrOfPinnedObject()
                Dim addr_dwSecond As IntPtr = gh_dwSecond.AddrOfPinnedObject()
                Dim addr_dwGlogExt As IntPtr = gh_dwGlogExt.AddrOfPinnedObject()

                Dim ret As Byte = _GetGeneralLogData_Ext(dwMachineNumber, addr_dwTMachineNumber, addr_dwEnrollNumber, addr_dwEMachineNumber, addr_dwVerifyMode, addr_dwYear,
                    addr_dwMonth, addr_dwDay, addr_dwHour, addr_dwMinute, addr_dwSecond, addr_dwGlogExt)
        ...
        End Function
        <DllImport("SBXPCDLL.dll", CallingConvention:=CallingConvention.Winapi)>
        Private Shared Function _ReadAllGLogData_Ext(dwMachineNumber As Int32) As Byte
        End Function

        Public Shared Function ReadAllGLogData_Ext(dwMachineNumber As Int32) As Boolean
            Return _ReadAllGLogData_Ext(dwMachineNumber) > 0
        End Function
        ...
        End Function
        <DllImport("SBXPCDLL.dll", CallingConvention:=CallingConvention.Winapi)>
        Private Shared Function _GetAllGLogData_Ext(dwMachineNumber As Int32, dwTMachineNumber As IntPtr, dwEnrollNumber As IntPtr, dwEMachineNumber As IntPtr, dwVerifyMode As IntPtr, dwYear As IntPtr,
            dwMonth As IntPtr, dwDay As IntPtr, dwHour As IntPtr, dwMinute As IntPtr, dwSecond As IntPtr, dwGlogExt As IntPtr) As Byte
        End Function

        Public Shared Function GetAllGLogData_Ext(dwMachineNumber As Int32, ByRef dwTMachineNumber As Int32, ByRef dwEnrollNumber As Int32, ByRef dwEMachineNumber As Int32, ByRef dwVerifyMode As Int32, ByRef dwYear As Int32,
            ByRef dwMonth As Int32, ByRef dwDay As Int32, ByRef dwHour As Int32, ByRef dwMinute As Int32, ByRef dwSecond As Int32, ByRef dwGlogExt As Int32) As Boolean
            dwTMachineNumber = 0
            dwEnrollNumber = 0
            dwEMachineNumber = 0
            ...
            Try
                ...
                Dim ret As Byte = _GetAllGLogData_Ext(dwMachineNumber, addr_dwTMachineNumber, addr_dwEnrollNumber, addr_dwEMachineNumber, addr_dwVerifyMode, addr_dwYear,
                    addr_dwMonth, addr_dwDay, addr_dwHour, addr_dwMinute, addr_dwSecond, addr_dwGlogExt)
...
#End Region
        ...
        <DllImport("SBXPCDLL.dll", CallingConvention:=CallingConvention.Winapi)>
        Private Shared Function _ReadGLogWithPos_Ext(dwMachineNumber As Int32, dwStartPos As Int32, dwEndPos As Int32) As Boolean
        End Function
        Public Shared Function ReadGLogWithPos_Ext(dwMachineNumber As Integer, dwStartPos As Integer, dwEndPos As Integer) As Boolean
            Return _ReadGLogWithPos_Ext(dwMachineNumber, dwStartPos, dwEndPos)
        End Function
        ...
        <DllImport("SBXPCDLL.dll", CallingConvention:=CallingConvention.Winapi)>
        Private Shared Function _GetLastBigUserId_AsString1(dwMachineNumber As Int32, dwIsLocal As Int32, ByRef lpszStrBase10 As IntPtr, ByRef lpszStrBase16 As IntPtr, ByRef lpszStrBase36 As IntPtr) As Byte
        End Function
        Public Shared Function GetLastBigUserId_AsString1(dwMachineNumber As Int32, ByRef lpszStr As String, Optional IsRadix36 As Boolean = True) As Boolean
            ...
            Try
                Dim ret As Boolean
                ret = _GetLastBigUserId_AsString1(dwMachineNumber, 1, ptr10, ptr16, ptr36) > 0
                If IsRadix36 = True Then
                    lpszStr = Marshal.PtrToStringUni(ptr36)
                Else
                    lpszStr = Marshal.PtrToStringUni(ptr10)
                End If
                Return ret
            Catch generatedExceptionName As Exception
                Return False
        ...
        <DllImport("SBXPCDLL.dll", CallingConvention:=CallingConvention.Winapi)>
        Private Shared Function _SetLastBigUserId_AsString1(dwMachineNumber As Int32, dwIsLocal As Int32, ByRef lpszStrBase10 As IntPtr, ByRef lpszStrBase16 As IntPtr, ByRef lpszStrBase36 As IntPtr) As Byte
        End Function
        Public Shared Function SetLastBigUserId_AsString1(dwMachineNumber As Int32, lpszStr As String, Optional IsRadix36 As Boolean = True) As Boolean
            If lpszStr Is Nothing Then
                Return False
            End If
            Dim ptr10 As IntPtr = IntPtr.Zero
            Dim ptr16 As IntPtr = IntPtr.Zero
            Dim ptr36 As IntPtr = IntPtr.Zero
            If IsRadix36 = True Then
            ...
            End If
            Try
                Return _SetLastBigUserId_AsString1(dwMachineNumber, 0, ptr10, ptr16, ptr36) > 0
            Catch ex As Exception
                Return False
            End Try
        End Function

        Private Shared Function BigUserId_Base36_to_Base10(lpszStrBase36 As String) As String
            Dim ptr10 As IntPtr = IntPtr.Zero
            Dim ptr16 As IntPtr = IntPtr.Zero
            Dim ptr36 As IntPtr = Marshal.StringToHGlobalUni(lpszStrBase36)

            _SetLastBigUserId_AsString1(1, 1, ptr10, ptr16, ptr36)
            _GetLastBigUserId_AsString1(1, 1, ptr10, ptr16, ptr36)

            Return Marshal.PtrToStringUni(ptr10)
        End Function
        Private Shared Function BigUserId_Base10_to_Base36(lpszStrBase10 As String) As String
            Dim ptr10 As IntPtr = Marshal.StringToHGlobalUni(lpszStrBase10)
            Dim ptr16 As IntPtr = IntPtr.Zero
            Dim ptr36 As IntPtr = IntPtr.Zero
        ...
        <DllImport("SBXPCDLL.dll", CallingConvention:=CallingConvention.Winapi)>
        Private Shared Function _GetDeviceModel(dwMachineNumber As Int32, dwisBigUser As IntPtr, dwCompanyType As IntPtr, dwMachineType As IntPtr, dwMachineVersion As IntPtr) As Byte
        End Function
        Public Shared Function GetDeviceModel(dwMachineNumber As Int32, ByRef dwIsBigUser As Int32, ByRef dwCompanyType As Int32, ByRef dwMachineType As Int32, ByRef dwMachineVersion As Int32) As Boolean
            dwIsBigUser = 0
            dwCompanyType = 0
            dwMachineType = 0
            dwMachineVersion = 0

            Dim bin_dwIsBigUser As Byte() = New Byte(4) {}
            Dim bin_dwCompanyType As Byte() = New Byte(4) {}
            Dim bin_dwMachineType As Byte() = New Byte(4) {}
            Dim bin_dwMachineVersion As Byte() = New Byte(4) {}
            Dim gh_dwIsBigUser As GCHandle = GCHandle.Alloc(bin_dwIsBigUser, GCHandleType.Pinned)
            Dim gh_dwCompanyType As GCHandle = GCHandle.Alloc(bin_dwCompanyType, GCHandleType.Pinned)
            Dim gh_dwMachineType As GCHandle = GCHandle.Alloc(bin_dwMachineType, GCHandleType.Pinned)
            Dim gh_dwMachineVersion As GCHandle = GCHandle.Alloc(bin_dwMachineVersion, GCHandleType.Pinned)

            Try
                Dim addr_dwIsBigUser As IntPtr = gh_dwIsBigUser.AddrOfPinnedObject()
                Dim addr_dwCompanyType As IntPtr = gh_dwCompanyType.AddrOfPinnedObject()
                Dim addr_dwMachineType As IntPtr = gh_dwMachineType.AddrOfPinnedObject()
                Dim addr_dwMachineVersion As IntPtr = gh_dwMachineVersion.AddrOfPinnedObject()

                Dim ret As Byte = _GetDeviceModel(dwMachineNumber, addr_dwIsBigUser, addr_dwCompanyType, addr_dwMachineType, addr_dwMachineVersion)

                dwIsBigUser = New BinaryReader(New MemoryStream(bin_dwIsBigUser)).ReadInt32()
                dwCompanyType = New BinaryReader(New MemoryStream(bin_dwCompanyType)).ReadInt32()
                dwMachineType = New BinaryReader(New MemoryStream(bin_dwMachineType)).ReadInt32()
                dwMachineVersion = New BinaryReader(New MemoryStream(bin_dwMachineVersion)).ReadInt32()
            ...
            Finally
                gh_dwIsBigUser.Free()
                gh_dwCompanyType.Free()
                gh_dwMachineType.Free()
                gh_dwMachineVersion.Free()
            End Try
        End Function
    End Class
End Namespace
