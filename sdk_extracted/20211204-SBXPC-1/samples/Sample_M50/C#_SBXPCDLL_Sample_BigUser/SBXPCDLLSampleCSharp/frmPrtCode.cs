...
namespace SBXPCDLLSampleCSharp
{
    public partial class frmPrtCode : Form
    {
		...
		private void cmdGetDeviceModel_Click(object sender, EventArgs e)
		{
			int dwIsBigUserId, dwCompanyType, dwMachineType, dwMachineVersion;
			sbxpc.SBXPCDLL.GetDeviceModel(Program.gMachineNumber,
				 out dwIsBigUserId, out dwCompanyType, out dwMachineType, out dwMachineVersion);

			string str = String.Format("IsBigUserId = {0}, CompanyType = {1}, MachineType = {2}, MachineVersion = {3}",
				dwIsBigUserId, dwCompanyType, dwMachineType, dwMachineVersion);
