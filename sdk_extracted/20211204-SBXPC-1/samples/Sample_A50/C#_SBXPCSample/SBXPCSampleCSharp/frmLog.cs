...
namespace SBXPCSampleCSharp
{
    public partial class frmLog : Form
    {
                ...
                while (true)
                {
                    ...
                    switch (vManipulation)
                    {
                        ...
                        case 17:
                            ...
                            break;
                        case 18:
                            gridSLogData.Text = Convert.ToString(vManipulation) + "--" + "Enroll Photo";
                            break;
                        case 19:
                            gridSLogData.Text = Convert.ToString(vManipulation) + "--" + "Delete Photo";
                            break;
                        default:
        ...
        private void cmdGlogData_Click(object sender, EventArgs e)
        {
            ...
            gstrLogItem = new Object[] { "", "MachineID", "UserID", "DoorNo", "VerifMode", "DateTime", "Photo ID" };
            ...
            if (vRet)
            {
                ...
                while (true)
                {
                    ...
                    gridSLogData.Text = Convert.ToString(vYear) + "/" + String.Format("{0:D2}", vMonth) + "/" + String.Format("{0:D2}", vDay) + " " + String.Format("{0:D2}", vHour) + ":" + String.Format("{0:D2}", vMinute);
                    gridSLogData.Col = 6;
                    gridSLogData.Text = Convert.ToString(vPhotoNumber);
                    LabelTotal.Text = "Total : " + Convert.ToString(i);
                    Application.DoEvents();
                    i = i + 1;
                ...
                if (i > vMaxLogCnt)
                {
                    ...
                    while (true)
                    {
                        ...
                        gridSLogData1.Col = 6;
                        gridSLogData1.Text = Convert.ToString(vPhotoNumber);
                        LabelTotal.Text = "Total : " + Convert.ToString(i);
                        Application.DoEvents();
                        i = i + 1;
                ...
                if (i > vMaxLogCnt)
                {
                    ...
                    while (true)
                    {
                        ...
                        gridSLogData2.Col = 6;
                        gridSLogData2.Text = Convert.ToString(vPhotoNumber);
        ...
        private void AddGLogItem(int vTMachineNumber, int vSEnrollNumber, int vPhotoNumber, int vVerifyMode, int vYear, int vMonth, int vDay, int vHour, int vMinute, int vSecond, int index, int vMaxLogCnt, AxMSFlexGridLib.AxMSFlexGrid gridGlogData)
        {
            int vDoor, vAntipass;
            string stDoor, stAntipass;
            int vDiv = 65536;
            ...
            gridGlogData.Col = 6;
            gridGlogData.Text = Convert.ToString(vPhotoNumber);
        }
        ...
        private void gridSLogData_ClickEvent(object sender, EventArgs e)
        {
            ...
            strPhotoNum = gridSLogData.get_TextMatrix(gridSLogData.Row, 6);
