...
Begin VB.Form frmEnroll 
   ...
   Begin VB.TextBox txtCardNumber1 
      BeginProperty Font 
      ...
      Width           =   1455
   End
   Begin VB.CommandButton cmdSetLongCardNum 
      Caption         =   "Set Long Card Number"
      BeginProperty Font 
         Name            =   "Times New Roman"
         Size            =   12
         Charset         =   0
      ...
      Width           =   3012
   End
   Begin VB.CommandButton cmdGetLongCardNum 
      Caption         =   "Get Long Card Number"
      BeginProperty Font 
         Name            =   "Times New Roman"
         Size            =   12
         Charset         =   0
   ...
   Begin VB.Frame Frame1 
      ...
      End
   End
   Begin VB.CommandButton cmdSetUserPeriod 
      Caption         =   "SetUserPeriod"
      BeginProperty Font 
         Name            =   "Times New Roman"
         Size            =   12
         Charset         =   0
      ...
      Width           =   3000
   End
   Begin VB.CommandButton cmdGetUserPeriod 
      Caption         =   "GetUserPeriod"
      BeginProperty Font 
         Name            =   "Times New Roman"
         Size            =   12
         Charset         =   0
   ...
   Begin MSComCtl2.DTPicker dtStartPeriod 
      ...
      CurrentDate     =   41085
   End
   Begin VB.CheckBox chkUsePeriod 
      Caption         =   "Use Period"
      BeginProperty Font 
         Name            =   "Times New Roman"
         Size            =   12
   ...
   Begin VB.ComboBox cmbBackupNumber 
      ...
      EndProperty
      Height          =   405
      ItemData        =   "frmEnroll.frx":04D3
      Left            =   2400
      List            =   "frmEnroll.frx":04EF
      TabIndex        =   0
...
Private Sub chkUsePeriod_Click()
    If chkUsePeriod.Value Then
        dtStartPeriod.Enabled = True
        dtEndPeriod.Enabled = True
    Else
        dtStartPeriod.Enabled = False
        dtEndPeriod.Enabled = False
    End If
End Sub
...
Private Sub cmdGetLongCardNum_Click()
    ...
    'make xml
    frmMain.SB100BPC1.XML_AddString strXML, "REQUEST", "GetLongCardNum"
    frmMain.SB100BPC1.XML_AddString strXML, "MSGTYPE", "request"
    frmMain.SB100BPC1.XML_AddInt strXML, "MachineID", mMachineNumber
    frmMain.SB100BPC1.XML_AddInt strXML, "UserID", vEnrollNumber
    ...
    If vRet = True Then
        lblMessage.Caption = "Get Long Card Number Success!"
        cmbPrivilege.ListIndex = frmMain.SB100BPC1.XML_ParseInt(strXML, "UserPriv")
        txtCardNumber.Text = frmMain.SB100BPC1.XML_ParseLong(strXML, "CardNum1")
        txtCardNumber1.Text = frmMain.SB100BPC1.XML_ParseLong(strXML, "CardNum2")
    Else
        frmMain.SB100BPC1.GetLastError vErrorCode
        lblMessage.Caption = ErrorPrint(vErrorCode)
    End If
...
Private Sub cmdGetUserInfo_Click()
    ...
    'make xml
    frmMain.SB100BPC1.XML_AddString strXML, "REQUEST", "GetUserInfo"
    frmMain.SB100BPC1.XML_AddString strXML, "MSGTYPE", "request"
    frmMain.SB100BPC1.XML_AddInt strXML, "MachineID", mMachineNumber
    frmMain.SB100BPC1.XML_AddInt strXML, "UserID", vEnrollNumber
    ...
    If vRet = True Then
        ...
        txtUserTZ1.Text = frmMain.SB100BPC1.XML_ParseInt(strXML, "Timezone1")
        txtUserTZ2.Text = frmMain.SB100BPC1.XML_ParseInt(strXML, "Timezone2")
        txtUserTZ3.Text = frmMain.SB100BPC1.XML_ParseInt(strXML, "Timezone3")
        txtUserGroup.Text = frmMain.SB100BPC1.XML_ParseInt(strXML, "GroupNo")
    Else
        frmMain.SB100BPC1.GetLastError vErrorCode
        lblMessage.Caption = ErrorPrint(vErrorCode)
    End If
...
Private Sub cmdGetUserPeriod_Click()
    Dim bRet As Boolean
    Dim vErrorCode As Long
    ...
    lUserID = Val(txtEnrollNumber.Text)
    
    'make xml
    frmMain.SB100BPC1.XML_AddString strXML, "REQUEST", "GetUserPeriod"
    frmMain.SB100BPC1.XML_AddString strXML, "MSGTYPE", "request"
    frmMain.SB100BPC1.XML_AddInt strXML, "MachineID", frmMain.gMachineNumber
    frmMain.SB100BPC1.XML_AddInt strXML, "UserID", lUserID
    
    bRet = frmMain.SB100BPC1.GeneralOperationXML(strXML)

    If bRet = True Then
        chkUsePeriod.Value = frmMain.SB100BPC1.XML_ParseInt(strXML, "Used")
        lStartDate = frmMain.SB100BPC1.XML_ParseInt(strXML, "Start")
        lEndDate = frmMain.SB100BPC1.XML_ParseInt(strXML, "End")
        If chkUsePeriod.Value Then
            yy = lStartDate / 256 / 256
            mm = (lStartDate - yy * 256 * 256) / 256
            dd = lStartDate And &HFF
            dtStartPeriod.Value = CStr(yy + 2000) & "/" & CStr(mm) & "/" & dd
            
            yy = lEndDate / 256 / 256
            mm = (lEndDate - yy * 256 * 256) / 256
            dd = lEndDate And &HFF
            dtEndPeriod.Value = CStr(yy + 2000) & "/" & CStr(mm) & "/" & dd
        Else
            dtStartPeriod.Enabled = False
            dtEndPeriod.Enabled = False
        End If
...
Private Sub cmdSetLongCardNum_Click()
    Dim vEnrollNumber As Long
    Dim vTimezone1 As Long
    Dim vTimezone2 As Long
    Dim vTimezone3 As Long
    Dim vGroupNo As Long
    Dim vRet As Boolean
    Dim vErrorCode As Long
    Dim strXML As String
    ...
    'make xml
    frmMain.SB100BPC1.XML_AddString strXML, "REQUEST", "SetLongCardNum"
    frmMain.SB100BPC1.XML_AddString strXML, "MSGTYPE", "request"
    frmMain.SB100BPC1.XML_AddInt strXML, "MachineID", mMachineNumber
    frmMain.SB100BPC1.XML_AddInt strXML, "UserID", vEnrollNumber
    frmMain.SB100BPC1.XML_AddInt strXML, "UserPriv", cmbPrivilege.ListIndex
    frmMain.SB100BPC1.XML_AddLong strXML, "CardNum1", Val(txtCardNumber.Text)
    frmMain.SB100BPC1.XML_AddLong strXML, "CardNum2", Val(txtCardNumber1.Text)
...
Private Sub cmdSetUserInfo_Click()
    ...
    vEnrollNumber = Val(txtEnrollNumber.Text)
    vTimezone1 = Val(txtUserTZ1.Text)
    vTimezone2 = Val(txtUserTZ2.Text)
    vTimezone3 = Val(txtUserTZ3.Text)
    vGroupNo = Val(txtUserGroup.Text)
    
    'make xml
    frmMain.SB100BPC1.XML_AddString strXML, "REQUEST", "SetUserInfo"
    frmMain.SB100BPC1.XML_AddString strXML, "MSGTYPE", "request"
    frmMain.SB100BPC1.XML_AddInt strXML, "MachineID", mMachineNumber
    frmMain.SB100BPC1.XML_AddInt strXML, "UserID", vEnrollNumber
    frmMain.SB100BPC1.XML_AddInt strXML, "Timezone1", vTimezone1
    frmMain.SB100BPC1.XML_AddInt strXML, "Timezone2", vTimezone2
    frmMain.SB100BPC1.XML_AddInt strXML, "Timezone3", vTimezone3
    frmMain.SB100BPC1.XML_AddInt strXML, "GroupNo", vGroupNo
...
Private Sub cmdSetUserPeriod_Click()
    Dim bRet As Boolean
    Dim vErrorCode As Long

    Dim lUserID As Long
    Dim lStartPeriod As Long, lEndPeriod As Long
    Dim lInfo As Long
    Dim strXML As String
    ...
    frmMain.SB100BPC1.XML_AddString strXML, "REQUEST", "SetUserPeriod"
    frmMain.SB100BPC1.XML_AddString strXML, "MSGTYPE", "request"
    frmMain.SB100BPC1.XML_AddInt strXML, "MachineID", frmMain.gMachineNumber
    frmMain.SB100BPC1.XML_AddInt strXML, "UserID", lUserID
    
    frmMain.SB100BPC1.XML_AddInt strXML, "Used", Val(chkUsePeriod.Value)
    If chkUsePeriod.Value Then
        lStartPeriod = (dtStartPeriod.Year - 2000) * 256 * 256 + dtStartPeriod.Month * 256 + dtStartPeriod.Day
        lEndPeriod = (dtEndPeriod.Year - 2000) * 256 * 256 + dtEndPeriod.Month * 256 + dtEndPeriod.Day
    Else
        lStartPeriod = 1 * 256 + 1
        lEndPeriod = 1 * 256 + 1
    End If
    frmMain.SB100BPC1.XML_AddInt strXML, "Start", lStartPeriod
    frmMain.SB100BPC1.XML_AddInt strXML, "End", lEndPeriod
...
Private Sub cmdSetUserPhoto_Click()
    ...
    frmMain.SB100BPC1.XML_AddInt strXML, "MachineID", mMachineNumber
    frmMain.SB100BPC1.XML_AddLong strXML, "UserID", vEnrollNumber
    frmMain.SB100BPC1.XML_AddLong strXML, "PhotoSize", vUserPhotoFileSize
...
err_proc:
    If Err.Number = 76 Then
        MsgBox "Please select photo file to set."
        txtUserPhotoFileName.SetFocus
    End If
    Exit Sub
End Sub
