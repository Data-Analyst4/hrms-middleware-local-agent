...
Private Sub cmdAllGLogData_Click()
    ...
    Dim vDoor As Long, vAntipass As Long
    Dim stDoor As String, stAntipass As String
    ...
    gstrLogItem = Array("", "MachineID", "UserID", "DoorNo", "VerifMode", "DateTime", "Photo ID")
    With gridSLogData
        .Row = 0
        .ColWidth(0) = 600
        For i = 1 To 6
        ...
        With gridSLogData
            ...
            Do
                ...
                Select Case vManipulation
                    ...
                    Case 15
                        .Text = vManipulation & "--" & "Delete All User"
                    Case 16
                        .Text = vManipulation & "--" & "Restore"
                    Case 17
                        .Text = vManipulation & "--" & "Modify User Period"
                    Case 18
                        .Text = vManipulation & "--" & "Enroll Photo"
                    Case 19
                        .Text = vManipulation & "--" & "Delete Photo"
                End Select
...
Private Sub gridSLogData_Click()
    ...
    End If
    With gridSLogData
        photoNumber = Val(.TextMatrix(.Row, 6))
