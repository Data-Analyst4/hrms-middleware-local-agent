...
Begin VB.Form frmMain 
   ...
   Begin VB.Frame frmMainfrmMainfrmMainfrmMainfrmMainfrmMainfrmMainfrmMainfrmMainfrmMainfrmMainfrmMainfrmMainfrmMainfrmMain 
      ...
      Top             =   1200
      Width           =   3840
      Begin VB.CommandButton cmdDoorKey 
         Caption         =   "Door Settings Management"
         BeginProperty Font 
            Name            =   "Times New Roman"
            Size            =   12
            Charset         =   0
      ...
      Begin VB.CommandButton btnTZone 
         ...
         Width           =   3045
      End
      Begin VB.CommandButton cmdMiscSettings 
         Caption         =   "Access Misc Settings"
         BeginProperty Font 
            Name            =   "Times New Roman"
            Size            =   12
            Charset         =   0
...
Private Sub cmdDoorKey_Click()
    Me.Visible = False
    frmDoorKey.Visible = True
End Sub
...
Private Sub cmdMiscSettings_Click()
    Me.Visible = False
    frmMiscSettings.Visible = True
End Sub
