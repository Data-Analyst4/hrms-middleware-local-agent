...
Private Sub cmdGetDeviceInfo_Click()
    ...
    If vRet = True Then
        Select Case vInfo
            ...
            Case 22: lblMessage.Caption = "(22) = Main Lock Group = " & vValue(0)
        End Select
    Else
        frmMain.SB100BPC1.GetLastError vErrorCode
        lblMessage.Caption = ErrorPrint(vErrorCode)
...
Private Sub cmdSetDeviceInfo_Click()
    ...
    If vRet = True Then
        ...
        'SmackBio
        If vInfo = 2 Then
            frmMain.SB100BPC1.Disconnect
            frmMain.cmbMachineNumber.ListIndex = vValue - 1
            frmMain.gMachineNumber = vValue
