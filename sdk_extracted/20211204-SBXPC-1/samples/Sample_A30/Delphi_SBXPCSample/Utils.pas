...
uses Windows, Unit_Main, SysUtils, SBXPCLib_TLB;
...
function MakeXMLCommandHeader(bpc :TSBXPC; strCmd : string) : WideString;
...
begin
    strXML := '';
    bpc.XML_AddString(strXML, 'REQUEST', PWideChar(WideString(strCmd)));
    bpc.XML_AddString(strXML, 'MsgType', 'request');
    bpc.XML_AddInt(strXML, 'MachineID', gMachineNumber);
