...
namespace SBXPCSampleCSharp
{
    public partial class frmPrtCode : Form
    {
        ...
        private void btnGetDeviceDetailInfo_Click(object sender, EventArgs e)
        {
            Boolean vRet = true;
            int vErrorCode = 0;
            ...
            string strXML = null;
            bpc.XML_AddString(ref strXML, "REQUEST", "GetDeviceDetails");
            ...
            if (vRet)
            {
                ...
                string sMacAddr = "";
                bpc.XML_ParseString(ref strXML, "MAC", ref sMacAddr);
