...
namespace SBXPCSampleCSharp
{
    public partial class frmLog : Form
    {
        ...
        private void cmdSLogData_Click(object sender, EventArgs e)
        {
            ...
            int vSEnrollNumber_l = 0;
            int vSEnrollNumber_h = 0;
            string vSEnrollNumber;
            int vGEnrollNumber_l = 0;
            int vGEnrollNumber_h = 0;
            string vGEnrollNumber = "";
            int vManipulation = 0;
            int vFingerNumber = 0;
            int vYear = 0;
            int vMonth = 0;
            ...
            gstrLogItem = new Object[] { "", "TMNo", "SEnlNo", "GEnlNo", "Manipulation", "FpNo", "DateTime" };
            ...
            gridSLogData.set_ColAlignment(4, 2);
            gridSLogData.set_ColWidth(5, 800);
            gridSLogData.Col = 6;
            gridSLogData.Text = (string)gstrLogItem[6];
            ...
            if (vRet)
            {
                ...
                while (true)
                {
                    vRet = bpc.GetSuperLogData( Program.gMachineNumber, 
                                                ref vTMachineNumber, 
                                                ref vSEnrollNumber_l,
                                                ref vSEnrollNumber_h, 
                                                ref vGEnrollNumber_l,
                                                ref vGEnrollNumber_h, 
                                                ref vManipulation, 
                                                ref vFingerNumber, 
                                                ref vYear, 
                                                ref vMonth, 
                    ...
                    {
                        if (!util.GetLastBigUserId_AsString1(Program.gMachineNumber, out vSEnrollNumber))
                            break;
                    }
                    else
                    {
                        ...
                        bpc.XML_AddLong(ref strXML, "LowPart", vSEnrollNumber_l);
                        bpc.XML_AddLong(ref strXML, "HighPart", vSEnrollNumber_h);
                        vRet = bpc.GeneralOperationXML(ref strXML);
                        if (!vRet) break;
                        vSEnrollNumber = "";
                        bpc.XML_ParseString(ref strXML, "QID", ref vSEnrollNumber);

                        strXML = "";
                        util.MakeXMLRequestHeader(bpc, ref strXML, "GetQIDString");
                        bpc.XML_AddLong(ref strXML, "LowPart", vGEnrollNumber_l);
                        bpc.XML_AddLong(ref strXML, "HighPart", vGEnrollNumber_h);
                        vRet = bpc.GeneralOperationXML(ref strXML);
                        if (!vRet) break;
                        vGEnrollNumber = "";
                        bpc.XML_ParseString(ref strXML, "QID", ref vGEnrollNumber);
                    }
                    ...
                    gridSLogData.Col = 2;
                    gridSLogData.Text = vSEnrollNumber;
                    gridSLogData.Col = 3;
                    gridSLogData.Text = vGEnrollNumber;
                    gridSLogData.Col = 4;
        ...
        private void cmdGlogData_Click(object sender, EventArgs e)
        {
            ...
            gstrLogItem = new Object[] { "", "PhotoNo", "EnrollNo", "VeriMode", "DateTime" };
            ...
            gridSLogData.set_ColWidth(3, 2000);
            gridSLogData.Col = 4;
            gridSLogData.set_ColWidth(4, 2000);
            gridSLogData.set_ColWidth(5, 700);
            ...
            gridSLogData1.set_ColWidth(3, 2000);
            gridSLogData1.Col = 4;
            gridSLogData1.set_ColWidth(4, 2000);
            gridSLogData1.set_ColWidth(5, 700);
            ...
            gridSLogData2.set_ColWidth(3, 2000);
            gridSLogData2.Col = 4;
            gridSLogData2.set_ColWidth(4, 2000);
            gridSLogData2.set_ColWidth(5, 700);
        ...
        private void AddGLogItem(int vTMachineNumber, string vSEnrollNumber, int vVerifyMode, int vYear, int vMonth, int vDay, int vHour, int vMinute, int vSecond, int index, int vMaxLogCnt, AxMSFlexGridLib.AxMSFlexGrid gridGlogData)
        {
            ...
            gridGlogData.Col = 2;
            gridGlogData.Text = vSEnrollNumber;
