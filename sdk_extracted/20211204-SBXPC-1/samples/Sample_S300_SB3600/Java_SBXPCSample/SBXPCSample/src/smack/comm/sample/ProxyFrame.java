 ...
 * ProxyFrame.java
 *
 * Created on Aug 26, 2011, 6:56:55 PM
 */
...
public class ProxyFrame extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        txtProxyName = new javax.swing.JFormattedTextField();
        jScrollPane1 = new javax.swing.JScrollPane();
        lstProxy = new javax.swing.JList();
        ...
        org.jdesktop.application.ResourceMap resourceMap = org.jdesktop.application.Application.getInstance(smack.comm.sample.MainFrame.class).getContext().getResourceMap(ProxyFrame.class);
        ...
        txtProxyName.setFont(resourceMap.getFont("txtProxyName.font")); // NOI18N
        txtProxyName.setName("txtProxyName"); // NOI18N
        getContentPane().add(txtProxyName, new org.netbeans.lib.awtextra.AbsoluteConstraints(120, 60, 250, -1));

        jScrollPane1.setName("jScrollPane1"); // NOI18N

        lstProxy.setModel(listModel);
        lstProxy.setSelectionMode(javax.swing.ListSelectionModel.SINGLE_SELECTION);
        lstProxy.setName("lstProxy"); // NOI18N
        lstProxy.addMouseListener(new java.awt.event.MouseAdapter() {
            public void mouseClicked(java.awt.event.MouseEvent evt) {
                lstProxyMouseClicked(evt);
            }
        });
        jScrollPane1.setViewportView(lstProxy);
        ...
        setBounds((screenSize.width-585)/2, (screenSize.height-516)/2, 585, 516);
    }// </editor-fold>//GEN-END:initComponents

    private void lstProxyMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_lstProxyMouseClicked
        ProxyName depart = (ProxyName)lstProxy.getSelectedValue();
        txtProxyName.setText(depart.proxyName);
    }//GEN-LAST:event_lstProxyMouseClicked
    ...
    private javax.swing.JList lstProxy;
    private javax.swing.JFormattedTextField txtProxyName;
