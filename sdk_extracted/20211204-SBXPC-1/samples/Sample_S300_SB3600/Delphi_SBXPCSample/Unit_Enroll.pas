...
begin
    ...
    strXML := MakeXMLCommandHeader(bpc, 'GetUserPhotoData');
    bpc.XML_AddLong(strXML, 'UserID', vEnrollNum);
...
begin
    ...
    strXML := MakeXMLCommandHeader(bpc, 'SetUserPhotoData');
    bpc.XML_AddLong(strXML, 'UserID', StrToInt(txtEnrollNumber.Text));
...
begin
    ...
    strXML := MakeXMLCommandHeader(bpc, 'SetUserPhotoData');
    bpc.XML_AddLong(strXML, 'UserID', StrToInt(txtEnrollNumber.Text));
    bpc.XML_AddBinaryLong(strXML, 'PhotoData', vAddr, COMPRESS_PHOTO_SIZE);
