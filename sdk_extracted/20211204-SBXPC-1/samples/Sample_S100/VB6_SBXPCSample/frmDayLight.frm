...
Private Sub cmdRead_Click()
    ...
    bRet = frmMain.Fk528KM1.GetDeviceLongInfo(frmMain.gMachineNumber, 1, lngTime(0))
    If bRet = True Then
        dtpDate(0).Month = lngTime(0)
        dtpDate(0).Day = lngTime(1)
        dtpTime(0).Hour = lngTime(2)
        dtpTime(0).Minute = lngTime(3)
        bRet = frmMain.Fk528KM1.GetDeviceLongInfo(frmMain.gMachineNumber, 2, lngTime(0))
    End If
    ...
    If bRet = True Then
        ...
        bRet = frmMain.Fk528KM1.GetDeviceInfo(frmMain.gMachineNumber, 19, lngTime(0))
    End If
...
Private Sub cmdWrite_Click()
    ...
    bRet = frmMain.Fk528KM1.SetDeviceLongInfo(frmMain.gMachineNumber, 1, lngTime(0))
    ...
    If bRet = True Then
        ...
        bRet = frmMain.Fk528KM1.SetDeviceLongInfo(frmMain.gMachineNumber, 2, lngTime(0))
    End If
    
    If bRet = True Then
        lngTime(0) = txtOffset
        bRet = frmMain.Fk528KM1.SetDeviceInfo(frmMain.gMachineNumber, 19, lngTime(0))
    End If
