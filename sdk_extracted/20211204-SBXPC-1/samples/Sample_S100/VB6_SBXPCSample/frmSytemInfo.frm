...
Begin VB.Form frmSystemInfo 
   ...
   Begin VB.CommandButton cmdGetInOutStatus 
      Caption         =   "GetInOutStatus"
      BeginProperty Font 
...
Private Sub cmdEnableDevice_Click()
    ...
    vRet = frmMain.Fk528KM1.EnableDevice(mMachineNumber, vFlag)
    If vRet = True Then
        If vFlag = 1 Then
...
Private Sub cmdGetDeviceInfo_Click()
    ...
    vRet = frmMain.Fk528KM1.GetDeviceInfo(mMachineNumber, vInfo, vValue(0))
    If vRet = True Then
        Select Case vInfo
...
Private Sub cmdGetDeviceStaus_Click()
    ...
    vRet = frmMain.Fk528KM1.GetDeviceStatus(mMachineNumber, vStatus, vValue(0))
    If vRet = True Then
        Select Case vStatus
...
Private Sub cmdGetDeviceTime_Click()
    ...
    vRet = frmMain.Fk528KM1.GetDeviceTime(mMachineNumber, vYear, vMonth, vDay, vHour, vMinute, vSecond, vDayOfWeek)
    If vRet = True Then
...
Private Sub cmdGetDoorStatus_Click()
    ...
    vRet = frmMain.Fk528KM1.GetDoorStatus(mMachineNumber, vValue(0))
    If vRet = True Then
...
Private Sub cmdGetInOutStatus_Click()
    ...
    frmMain.Fk528KM1.XML_AddString strXML, "REQUEST", "GetInOutStatus"
    frmMain.Fk528KM1.XML_AddString strXML, "MSGTYPE", "request"
    frmMain.Fk528KM1.XML_AddString strXML, "MachineID", mMachineNumber
    bRet = frmMain.Fk528KM1.GeneralOperationXML(strXML)
    
    If bRet = True Then
        frmMain.Fk528KM1.XML_ParseString strXML, "ResultCode", strResultCode
        lblMessage.Caption = "In/Out Status : " + strResultCode
    Else
        frmMain.Fk528KM1.GetLastError vErrorCode
        lblMessage.Caption = ErrorPrint(vErrorCode)
    End If
...
Private Sub cmdPowerOn_Click()
    frmMain.Fk528KM1.PowerOnAllDevice
End Sub
...
Private Sub cmdSetDeviceInfo_Click()
    ...
    vRet = frmMain.Fk528KM1.SetDeviceInfo(mMachineNumber, vInfo, vValue)
    If vRet = True Then
        lblMessage.Caption = "Success!"
...
Private Sub cmdSetDeviceTime_Click()
    ...
    vRet = frmMain.Fk528KM1.SetDeviceTime(mMachineNumber)
    If vRet = True Then
        lblMessage.Caption = "Success!"
    Else
        frmMain.Fk528KM1.GetLastError vErrorCode
...
Private Sub cmdSetDoorStatus_Click()
    ...
    vRet = frmMain.Fk528KM1.SetDoorStatus(mMachineNumber, vValue)
    If vRet = True Then
        lblMessage.Caption = "Success!"
    Else
        frmMain.Fk528KM1.GetLastError vErrorCode
...
Private Sub PowerOffDevice_Click()
    ...
    vRet = frmMain.Fk528KM1.PowerOffDevice(mMachineNumber)
    If vRet = True Then
        lblMessage.Caption = "Success!"
    Else
        lblMessage.Caption = ErrorPrint(vErrorCode)
