...
Private Sub cmdGetBackupNumber_Click()
    ...
    vBackupNumber = frmMain.Fk528KM1.GetBackupNumber(mMachineNumber)
...
Private Sub cmdGetProductCode_Click()
    ...
    vRet = frmMain.Fk528KM1.GetProductCode(mMachineNumber, vProductCode)
    If vRet = True Then
...
Private Sub cmdGetSerialNumber_Click()
    ...
    vRet = frmMain.Fk528KM1.GetSerialNumber(mMachineNumber, vSerialNumber)
    If vRet = True Then
