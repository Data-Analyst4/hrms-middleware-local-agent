	...
	class GLogInfo
	{
        ...
        public string body_temperature
        {
            get
            {
                ...
                int body_temperature_10_delta = (dwGlogExt & 0xFF); // (body_temperature_10_delta: 8, mood: 2, reserved: 22)
		...
		public string mood
		{
			get
			{
				int v = ((dwGlogExt >> 8) & 0x3); // (body_temperature_10_delta: 8, mood: 2, reserved: 22)
