...
Friend Class frmLog
    ...
    Private Sub ShowGlogItem(ByVal vTMachineNumber As Integer, ByVal vSEnrollNumber As Integer, ByVal vSMachineNumber As Integer, ByVal vVerifyMode As Integer, ByVal vYear As Integer, ByVal vMonth As Integer, ByVal vDay As Integer, ByVal vHour As Integer, ByVal vMinute As Integer, ByVal vSecond As Integer, ByVal vGlogExt As Integer, ByVal vIndex As Integer, ByVal vMaxLogCnt As Integer, ByVal gridGlogData As AxMSFlexGridLib.AxMSFlexGrid)
        ...
        Dim mood_str As String = ""
        Dim mood As Integer = (vGlogExt >> 8) And &H3   ' (body_temperature_10_delta: 8, mood: 2, reserved: 22)

        If (mood > 0) Then
            mood_str = mood.ToString()
            If (mood = 1) Then
                mood_str += " (SAD)"
            ElseIf (mood = 2) Then
                mood_str += " (NORMAL)"
    ...
    Private Sub cmdAllGLogData_Click(ByVal eventSender As System.Object, ByVal eventArgs As System.EventArgs) Handles cmdAllGLogData.Click
        ...
        gstrLogItem = New Object() {"", "Photo No", "EnrollNo", "BodyTemp", "Mood", "EMachineNo", "VeriMode", "DateTime"}
        With gridSLogData
            .Row = 0
            .set_ColWidth(0, 600)
            For i = 1 To 7
        ...
        If Not (chkReadGlogExt.Checked) Then
            ...
            gridSLogData.set_ColWidth(4, 0)     ' col 4 : visible = false
        End If
        ...
        If vRet = True Then
            ...
            With gridSLogData
                ...
                Do
                    ...
                    ShowGlogItem(vTMachineNumber, vSEnrollNumber, vSMachineNumber, vVerifyMode, vYear, vMonth, vDay, vHour, vMinute, vSecond, vGlogExt, i, 0, gridSLogData)
            ...
            If i > vMaxLogCnt Then
                ...
                With gridSLogData1
                    Do
                        ...
                        ShowGlogItem(vTMachineNumber, vSEnrollNumber, vSMachineNumber, vVerifyMode, vYear, vMonth, vDay, vHour, vMinute, vSecond, vGlogExt, i, vMaxLogCnt, gridSLogData1)
            ...
            If i > vMaxLogCnt Then
                ...
                With gridSLogData2
                    Do
                        ...
                        ShowGlogItem(vTMachineNumber, vSEnrollNumber, vSMachineNumber, vVerifyMode, vYear, vMonth, vDay, vHour, vMinute, vSecond, vGlogExt, i, vMaxLogCnt, gridSLogData2)
    ...
    Private Sub gridSLogData_ClickEvent(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles gridSLogData.ClickEvent
        ...
        sbxpc.SBXPCDLL.XML_ParseBinaryLong(strXML, "PhotoData", AddrOfphotoData.ToInt32, nPhotoSize)
