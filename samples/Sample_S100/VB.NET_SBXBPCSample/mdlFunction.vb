...
Module mdlPublic
    ...
    Public Const MAX_BELLCOUNT_DAY As Short = 12
    ...
    Public Function MakeXMLCommandHeader(ByVal request As String) As String
        ...
        frmMain.SBXPC1.XML_AddString(MakeXMLCommandHeader, "REQUEST", request)
        frmMain.SBXPC1.XML_AddString(MakeXMLCommandHeader, "MSGTYPE", "request")
        frmMain.SBXPC1.XML_AddInt(MakeXMLCommandHeader, "MachineID", frmMain.gMachineNumber)
    End Function
