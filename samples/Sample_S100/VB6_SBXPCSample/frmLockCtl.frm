...
Private Sub cmdAutoRecover_Click()
    ...
    vRet = frmMain.Fk528KM1.SetDoorStatus(mMachineNumber, 4)
    If vRet = True Then
...
Private Sub cmdDoorOpen_Click()
    ...
    vRet = frmMain.Fk528KM1.SetDoorStatus(mMachineNumber, 3)
    If vRet = True Then
...
Private Sub cmdRestart_Click()
    ...
    vRet = frmMain.Fk528KM1.SetDoorStatus(mMachineNumber, 5)
    If vRet = True Then
...
Private Sub cmdUncondClose_Click()
    ...
    vRet = frmMain.Fk528KM1.SetDoorStatus(mMachineNumber, 2)
    If vRet = True Then
...
Private Sub cmdUncondOpen_Click()
    ...
    vRet = frmMain.Fk528KM1.SetDoorStatus(mMachineNumber, 1)
    If vRet = True Then
...
Private Sub cmdWarnCancel_Click()
    ...
    vRet = frmMain.Fk528KM1.SetDoorStatus(mMachineNumber, 6)
    If vRet = True Then
