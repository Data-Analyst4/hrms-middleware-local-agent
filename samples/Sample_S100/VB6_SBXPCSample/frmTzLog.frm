...
Private Sub cmdRead_Click()
    ...
    bRet = frmMain.Fk528KM1.GetDeviceLongInfo(frmMain.gMachineNumber, 5, DbTzLogArray(0))
...
Private Sub cmdWrite_Click()
    ...
    bRet = frmMain.Fk528KM1.SetDeviceLongInfo(frmMain.gMachineNumber, 5, DbTzLogArray(0))
