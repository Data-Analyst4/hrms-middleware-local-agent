...
Friend Class frmMain
    ...
    Private Sub btnSearch_Click(sender As Object, e As EventArgs) Handles btnSearch.Click
        Dim frm As frmDeviceSearch = New frmDeviceSearch
        frm.Activate()
        frm.Visible = True
    ...
    Private Sub btnCommParam_Click(sender As Object, e As EventArgs) Handles btnCommParam.Click
        Dim frm_SetCommParam As frmCommParam = New frmCommParam()
