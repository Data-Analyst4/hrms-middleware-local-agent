...
begin
    ...
    strXML := MakeXMLCommandHeader(bpc, 'SetGLogSearchRange');
    bpc.XML_AddBoolean(strXML, 'UseSearchRange', chkUseSearchRange.Checked);

    if chkUseSearchRange.Checked then
    begin
        DecodeDate(dtStart.Date, year, month, day);
        bpc.XML_AddLong(strXML, 'StartYear', year);
        bpc.XML_AddLong(strXML, 'StartMonth', month);
        bpc.XML_AddLong(strXML, 'StartDate', day);
        DecodeDate(dtEnd.Date, year, month, day);
        bpc.XML_AddLong(strXML, 'EndYear', year);
        bpc.XML_AddLong(strXML, 'EndMonth', month);
        bpc.XML_AddLong(strXML, 'EndDate', day);
    end;
...
begin
    ...
    strXML := MakeXMLCommandHeader(bpc, 'GetGLogPhotoData');
    bpc.XML_AddLong(strXML, 'PhotoPos', photoIndex);
    ...
    begin
        ...
        bpc.XML_ParseBinaryLong(strXML, 'PhotoData', vAddr, COMPRESS_PHOTO_SIZE);
