...
public class MainFrameView extends FrameView implements Application.ExitListener{
    ...
    private void enableManagementGroup(boolean bEnable)
    {
        ...
        btnScreenSaver.setEnabled(bEnable);
    ...
    private void initComponents() {
        ...
        lblDeviceUID = new javax.swing.JLabel();
        txtPassword = new javax.swing.JTextField();
        txtIPAddress = new javax.swing.JTextField();
        txtPortNumber = new javax.swing.JTextField();
        txtDeviceUID = new javax.swing.JTextField();
        optNetwork = new javax.swing.JRadioButton();
        optViaP2P = new javax.swing.JRadioButton();
        jPanel4 = new javax.swing.JPanel();
        btnExit = new javax.swing.JButton();
        btnLockControl = new javax.swing.JButton();
        btnEventCapture = new javax.swing.JButton();
        ...
        btnScreenSaver = new javax.swing.JButton();
        ...
        jPanel1.add(btnOpen, new org.netbeans.lib.awtextra.AbsoluteConstraints(320, 20, 90, 30));
        ...
        jPanel1.add(btnClose, new org.netbeans.lib.awtextra.AbsoluteConstraints(430, 20, 90, 30));
        ...
        lblDeviceUID.setFont(resourceMap.getFont("lblDeviceUID.font")); // NOI18N
        lblDeviceUID.setText(resourceMap.getString("lblDeviceUID.text")); // NOI18N
        lblDeviceUID.setName("lblDeviceUID"); // NOI18N
        jPanel3.add(lblDeviceUID, new org.netbeans.lib.awtextra.AbsoluteConstraints(20, 120, -1, -1));
        ...
        txtDeviceUID.setFont(resourceMap.getFont("txtDeviceUID.font")); // NOI18N
        txtDeviceUID.setText(resourceMap.getString("txtDeviceUID.text")); // NOI18N
        txtDeviceUID.setName("txtDeviceUID"); // NOI18N
        txtDeviceUID.setEnabled(false);
        jPanel3.add(txtDeviceUID, new org.netbeans.lib.awtextra.AbsoluteConstraints(100, 120, 150, -1));
        ...
        buttonGroup1.add(optViaP2P);
        optViaP2P.setFont(resourceMap.getFont("optNetwork.font")); // NOI18N
        optViaP2P.setSelected(false);
        optViaP2P.setText(resourceMap.getString("optViaP2P.text")); // NOI18N
        optViaP2P.setName("optViaP2P"); // NOI18N
        optViaP2P.addChangeListener(new javax.swing.event.ChangeListener() {
            public void stateChanged(javax.swing.event.ChangeEvent evt) {
            	optViaP2PStateChanged(evt);
            }
        });
        jPanel3.add(optViaP2P, new org.netbeans.lib.awtextra.AbsoluteConstraints(150, 0, -1, -1));

        mainPanel.add(jPanel3, new org.netbeans.lib.awtextra.AbsoluteConstraints(290, 140, 270, 160));
        ...
        jPanel4.add(btnExit, new org.netbeans.lib.awtextra.AbsoluteConstraints(20, 150, 210, 30));
        ...
        btnEventCapture.setFont(resourceMap.getFont("btnEventCapture.font")); // NOI18N
        btnEventCapture.setText(resourceMap.getString("btnEventCapture.text")); // NOI18N
        btnEventCapture.setName("btnEventCapture"); // NOI18N
        btnEventCapture.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                btnEventCaptureActionPerformed(evt);
            }
        });
        jPanel4.add(btnEventCapture, new org.netbeans.lib.awtextra.AbsoluteConstraints(20, 90, 210, 30));
        ...
        btnProductCode.addMouseListener(new java.awt.event.MouseAdapter() {
            public void mouseClicked(java.awt.event.MouseEvent evt) {
                btnProductCodeMouseClicked(evt);
            }
        });
        ...
        btnProxy.setFont(resourceMap.getFont("btnHoliday.font")); // NOI18N
        btnProxy.setText(resourceMap.getString("btnHoliday.text")); // NOI18N
        btnProxy.setEnabled(false);
        btnProxy.setName("btnHoliday"); // NOI18N
        btnProxy.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                btnProxyActionPerformed(evt);
            }
        });
        jPanel4.add(btnProxy, new org.netbeans.lib.awtextra.AbsoluteConstraints(400, 120, 130, 30));

        btnScreenSaver.setFont(resourceMap.getFont("btnModeTZone.font")); // NOI18N
        btnScreenSaver.setText(resourceMap.getString("btnModeTZone.text")); // NOI18N
        btnScreenSaver.setEnabled(false);
        btnScreenSaver.setName("btnModeTZone"); // NOI18N
        btnScreenSaver.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                btnScreenSaverActionPerformed(evt);
            }
        });
        jPanel4.add(btnScreenSaver, new org.netbeans.lib.awtextra.AbsoluteConstraints(270, 150, 260, 30));
        ...
        btnDepartment.setFont(resourceMap.getFont("btnDepartment.font")); // NOI18N
        btnDepartment.setText(resourceMap.getString("btnDepartment.text")); // NOI18N
        btnDepartment.setEnabled(false);
        btnDepartment.setName("btnDepartment"); // NOI18N
        btnDepartment.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                btnDepartmentActionPerformed(evt);
            }
        });
        jPanel4.add(btnDepartment, new org.netbeans.lib.awtextra.AbsoluteConstraints(270, 120, 130, 30));

        mainPanel.add(jPanel4, new org.netbeans.lib.awtextra.AbsoluteConstraints(10, 310, 550, 200));
        ...
        mainPanel.add(jPanel5, new org.netbeans.lib.awtextra.AbsoluteConstraints(10, 140, 270, 160));
    ...
    private void optViaP2PStateChanged(javax.swing.event.ChangeEvent evt) {//GEN-FIRST:event_optViaP2PStateChanged
        if(optViaP2P.isSelected())
            switchConnectMode(ConnectMode.viaP2P);
    }//GEN-LAST:event_optViaP2PStateChanged
    ...
    private void btnProductCodeMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_btnProductCodeMouseClicked
        
    }//GEN-LAST:event_btnProductCodeMouseClicked
    ...
    private void btnEventCaptureActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnEventCaptureActionPerformed
        EventCaptureFrame event_frame = new EventCaptureFrame();
        event_frame.setVisible(true);
        this.getFrame().setVisible(false);
    }//GEN-LAST:event_btnEventCaptureActionPerformed
    ...
    private void btnScreenSaverActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnScreenSaverActionPerformed
        ScreenSaverFrame screenSaver_frame = new ScreenSaverFrame();
        screenSaver_frame.setVisible(true);
        this.getFrame().setVisible(false);
    }//GEN-LAST:event_btnScreenSaverActionPerformed
    ...
    private javax.swing.JButton btnEventCapture;
    ...
    private javax.swing.JButton btnScreenSaver;
    ...
    private javax.swing.JLabel lblDeviceUID;
    ...
    private javax.swing.JRadioButton optViaP2P;
    ...
    private javax.swing.JTextField txtDeviceUID;
