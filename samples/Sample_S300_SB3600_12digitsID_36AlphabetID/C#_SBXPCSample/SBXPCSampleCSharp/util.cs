...
//        Public Declare Function GetSystemDefaultLangID Lib "kernel32" () As Short
        ...
        public static bool gIsBigUserId = false;
        public static bool gIsS300 = false;
        public static bool gIsS300_W = false;
        ...
        static extern byte _GetLastBigUserId_AsString1(
            ...
            Int32 dwMachineNumber, out string lpszStr, bool IsRadix36 = true)
        {
            ...
            try
            {
                bool ret = _GetLastBigUserId_AsString1(dwMachineNumber, 1 /*already on PC*/, out ptr10, out ptr16, out ptr36) > 0;
